...
/**
 * Kullanıcıyı daha yüksek bir plana geçirir (upgrade)
 * @param userId Kullanıcı ID
 * @param newPlanId Yeni plan ID
 * @param stripeSubscriptionId Stripe subscription ID
 * @returns Güncellenmiş subscription bilgisi
 */
export const upgradeSubscription = async ({ userId, newPlanId, stripeSubscriptionId }: {
  userId: string,
  newPlanId: string,
  ...
  // Stripe'da subscription'ı güncelle
